<p align="center">
  ...
  <h1 align="center">The UzAniGuard Bot</h1>
</p>
The UzAniGuard is a Telegram bot made to help admins manage their groups.

Initially created to moderate [UzHackintosh](https://t.me/uzhackintosh), and [The UzAnimation](https://t.me./uzanimation).

**NOTE: The UzAniGuard is in beta phase;**
**it has known issues, but it's successfully being used in production**

If you need help with using the Bot or setting it up, join our [Support Chat](https://t.me/uzhackintosh).

## Setup
You need [Node.js](https://nodejs.org/) (>= 12) to run this bot.

1. Create a bot via [@BotFather](https://t.me/BotFather) and grab a **token**.
2. [Clone this repository](https://github.com/Genemator/uzaniguard.git).
...
4. Run `docker build -t the_uzaniguard_bot .` to build image.
5. Run `docker run --rm -itd the_uzaniguard_bot` to start the bot.
...
The bot is still in beta phase so feel free to [open issues](https://github.com/Genemator/uzaniguard/issues/new) and ask for features.
